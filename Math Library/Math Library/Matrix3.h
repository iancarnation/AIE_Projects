...
class Matrix3
{
	public:
		...
		void operator *= (Matrix3& a_rM2);									// sets a matrix equal to itself multiplied by another matrix
		float operator () (unsigned int a_iRow, unsigned int a_iCol);// returns matrix at index specified by (row, column)
