...
class Matrix4
{
	public:
		...
		Matrix4(float a11, float a12, float a13,
		...
		void TransformVector(Vector4 a_vector, float a_fAngle, float a_fScale);		// rotate and scales a directional vector
	...
	private:
		...
		Matrix4 CreateRotation(float a_fAngle) const;				// creates new rotation matrix with 0,0 translation
