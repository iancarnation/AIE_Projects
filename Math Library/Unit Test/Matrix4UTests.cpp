...
// this may be redundant because no 4d vector will be a directional vector?
// rotate and scales a directional vector -------------------------------------------------------------
void M4TransformVectorTest::SetData(Vector4 a_oV, float a_fA, float a_fS, char a_cAxis, Vector4 a_oExpResult)
{
	m_oVector = a_oV;
	m_fAngle = a_fA;
	m_fScale = a_fS;
...
void M4TransformPointTest::SetData(Vector4 a_oV, float a_fA, float a_fS, char a_cAxis, Vector4 a_oTrV, Vector4 a_oExpResult)
{
	m_oVector = a_oV;
	m_fAngle = a_fA;
	m_fScale = a_fS;
...
void M4CreateRotationTest::SetData(Matrix4 a_oM, float a_fA, char a_cAxis, Matrix4 a_oExpResult)
{
	m_oMatrix = a_oM;
	m_fAngle = a_fA;
	m_cAxis = a_cAxis;
...
{
	Matrix4 Result = m_oMatrix.CreateRotation(m_fAngle, m_cAxis);
...
void M4CreateCardinalOrthoTest::SetData(Matrix4 a_oM, plane3D a_PLANE, Matrix4 a_oExpResult)
{
	m_oMatrix = a_oM;
	m_plane = a_PLANE;
	m_oResult = a_oExpResult;
...
{
	Matrix4 Result = m_oMatrix.CreateCardinalOrthoProj(m_plane);
