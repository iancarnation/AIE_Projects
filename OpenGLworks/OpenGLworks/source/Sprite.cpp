...
Sprite::Sprite(const char* a_pTexture, int a_iWidth, int a_iHeight, Vector4 a_v4Color, GLFWwindow* window)
{
	...
	*/
	...
	m_aoVerts[0].UV[0] = 1.0f;m_aoVerts[0].UV[1] = 0.0f;
	m_aoVerts[1].UV[0] = 0.0f;m_aoVerts[1].UV[1] = 0.0f;
	m_aoVerts[2].UV[0] = 1.0f;m_aoVerts[2].UV[1] = 1.0f;
	m_aoVerts[3].UV[0] = 0.0f;m_aoVerts[3].UV[1] = 1.0f;
